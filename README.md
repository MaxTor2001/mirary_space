...
Онлайн-оплаты пока нет: заказ оформляется с оплатой при получении. Что нужно сделать владельцу
магазина, чтобы подключить ЮKassa, — в [docs/PAYMENTS.md](docs/PAYMENTS.md).
