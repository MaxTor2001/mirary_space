...
PRODUCTS = [
    ("Титановый лабрет Mirari Classic", "ears", "Титан G23", "1.2x8 мм", 1490, 10, 24),
    ("Кольцо-кликер для септума", "nose", "Хирургическая сталь 316L", "1.2x10 мм", 1290, 0, 30),
    ("Нострила с кристаллом Swarovski", "nose", "Титан G23", "0.8x6.5 мм", 1890, 15, 12),
    ("Штанга для языка с шариками", "lips", "Хирургическая сталь 316L", "1.6x16 мм", 990, 0, 40),
    ("Лабрет для губы с опалом", "lips", "Титан G23", "1.2x8 мм", 2190, 10, 8),
    ("Банан для пупка с подвеской", "body", "Хирургическая сталь 316L", "1.6x10 мм", 1590, 0, 18),
    ("Микродермал титановый", "body", "Титан G23", "1.2x2.5 мм", 890, 0, 50),
    ("Индастриал-штанга", "ears", "Титан G23", "1.6x38 мм", 2490, 20, 6),
    ("Туннель из акрила, пара", "ears", "Акрил", "10 мм", 690, 0, 35),
    ("Игла-катетер для пирсинга, 10 шт", "care", "Сталь", "16G", 1190, 0, 25),
    ("Зажим Пеннингтона", "care", "Сталь", "универсальный", 2890, 5, 7),
    ("Антисептик Miramistin 150 мл", "care", "—", "150 мл", 590, 0, 60),
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for name, cat_slug, material, size, price, discount, quantity in PRODUCTS:
            ...
            Product.objects.update_or_create(
                ...
                defaults={
                    ...
                    "discount": discount,
                    "quantity": quantity,
                    "description": f"{name}. Материал: {material}. Размер: {size}. "
